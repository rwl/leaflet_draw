...
/**
 * Poly is an editing handler for polylines and polygons.
 */
class Poly extends Handler {
  ...
  Poly(poly, options) : super(poly, options) {
    this._poly = poly;
  ...
  _initMarkers() {
    ...
    for (var i = 0, j = len - 1; i < len; j = i++) {
      if (i == 0 && !(L.Polygon && (this._poly is leaflet.Polygon))) {
        continue;
      }
  ...
  _onMarkerClick(e) {
    var minPoints = L.Polygon && (this._poly is leaflet.Polygon) ? 4 : 3,
      marker = e.target;
